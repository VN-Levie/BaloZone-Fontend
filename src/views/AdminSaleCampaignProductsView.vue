            ...
            <form v-if="selectedProduct" @submit.prevent="updateProductSale">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input 
                    v-model.number="editForm.original_price"
                    type="number" 
                    class="form-control"
                ...
                <div class="col-md-6">
                  ...
                  <input 
                    v-model.number="editForm.discount_percentage"
                    type="number" 
                    class="form-control"
                    min="0"
                    max="100"
                ...
                <div class="col-md-6">
                  ...
                  <input 
                    v-model.number="editForm.max_quantity"
                    type="number" 
                    class="form-control"
                    min="0"
