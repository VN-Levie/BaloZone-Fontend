        ...
        <div class="row mb-4">
            ...
            <div class="chart-card">
              <div class="chart-header">
                ...
                <div class="chart-controls">
                  <button v-for="period in ['7d', '30d', '90d', '1y']" :key="period" @click="selectedPeriod = period" class="btn btn-sm" :class="selectedPeriod === period ? 'btn-primary' : 'btn-outline-secondary'">
                    {{ period }}
                  </button>
                </div>
              </div>
              <SalesChart :data="salesChartData" type="line" :height="300" />
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-5 mb-4">
            <div class="chart-card">
              ...
              <SalesChart :data="ordersStatusChartData" type="doughnut" :height="300" />
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button v-if="canManageProducts" @click="showCreateProduct = true" class="btn btn-primary btn-sm">
          ...
          <div class="card-body">
            ...
            <div v-else>
              ...
              <div v-else class="list-group list-group-flush">
                <div v-for="product in recentProducts" :key="product.id" class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="me-auto">
                    <div class="fw-bold">{{ product.name }}</div>
                    <small class="text-muted">{{ formatPrice(product.price) }}</small>
                  </div>
                  <div>
                    <button v-if="canManageProducts" @click="editProduct(product)" class="btn btn-outline-primary btn-sm me-1">
                      <i class="fas fa-edit"></i>
                    </button>
                    <button v-if="canManageProducts" @click="deleteProduct(product.id)" class="btn btn-outline-danger btn-sm">
      ...
      <div class="col-md-6 mb-4">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button v-if="canManageNews" @click="showCreateNews = true" class="btn btn-primary btn-sm">
          ...
          <div class="card-body">
            ...
            <div v-else>
              ...
              <div v-else class="list-group list-group-flush">
                <div v-for="article in recentNews" :key="article.id" class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="me-auto">
                    <div class="fw-bold">{{ article.title }}</div>
                    <small class="text-muted">{{ formatDate(article.created_at) }}</small>
                  </div>
                  <div>
                    <button v-if="canManageNews" @click="editNews(article)" class="btn btn-outline-primary btn-sm me-1">
                      <i class="fas fa-edit"></i>
                    </button>
                    <button v-if="canManageNews" @click="deleteNews(article.id)" class="btn btn-outline-danger btn-sm">
                      <i class="fas fa-trash"></i>
                    </button>
                  </div>
                </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div v-else>
              ...
              <div v-else class="list-group list-group-flush">
                <div v-for="order in recentOrders" :key="order.id" class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="me-auto">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div v-else>
              ...
              <div v-else class="list-group list-group-flush">
                <div v-for="user in recentUsers" :key="user.id" class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="me-auto">
                    <div class="fw-bold">{{ user.name }}</div>
                    <small class="text-muted">{{ user.email }}</small>
                  </div>
                  <div>
                    <RoleBadge v-for="role in user.roles" :key="role.id" :role="role" class="me-1" />
                  </div>
                </div>
              </div>
            </div>
...
const deleteProduct = async (productId: number) => {
  ...
  try {
    ...
    // Reload recent products after deletion
    // loadRecentData()
  } catch (error) {
...
const deleteNews = async (articleId: number) => {
  if (!confirm('Bạn có chắc chắn muốn xóa bài viết này?')) return

  try {
    // TODO: Implement news deletion API call
    console.log('Delete news:', articleId)
    // Reload recent news after deletion
    // loadRecentData()
  } catch (error) {
