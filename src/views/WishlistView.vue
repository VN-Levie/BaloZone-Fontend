    ...
    <div class="wishlist-page">
      <div class="container-fluid px-4 py-4">
        ...
        <div v-else class="wishlist-content">
          ...
          <div class="row g-3">
            <div v-for="product in wishlistItems" :key="product.id" class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-4">
              <div class="wishlist-item">
                <ProductCard :product="product" />
                <button class="remove-btn" @click="removeItem(product.id)" title="Xóa khỏi danh sách yêu thích">
