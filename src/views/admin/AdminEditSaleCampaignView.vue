                ...
                <div class="form-card">
                  ...
                  <div class="row g-3">
                    <div class="col-12">
                      ...
                      <input id="name" v-model="form.name" type="text" class="form-control" :class="{ 'is-invalid': errors.name }" placeholder="Nhập tên chiến dịch khuyến mãi..." required />
                    ...
                    <div class="col-12">
                      ...
                      <input id="slug" v-model="form.slug" type="text" class="form-control" :class="{ 'is-invalid': errors.slug }" placeholder="Tự động tạo từ tên chiến dịch" />
                    ...
                    <div class="col-12">
                      ...
                      <textarea id="description" v-model="form.description" class="form-control" :class="{ 'is-invalid': errors.description }" rows="4" placeholder="Mô tả chi tiết về chiến dịch khuyến mãi..." required></textarea>
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="start_date" v-model="form.start_date" type="datetime-local" class="form-control" :class="{ 'is-invalid': errors.start_date }" required />
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="end_date" v-model="form.end_date" type="datetime-local" class="form-control" :class="{ 'is-invalid': errors.end_date }" required />
              ...
              <div class="col-lg-4">
                ...
                <div class="form-card">
                  ...
                  <div class="mb-3">
                    ...
                    <input id="priority" v-model.number="form.priority" type="number" min="0" max="100" class="form-control" :class="{ 'is-invalid': errors.priority }" placeholder="0" />
                  ...
                  <div class="mb-3">
                    <div class="form-check">
                      <input id="is_featured" v-model="form.is_featured" type="checkbox" class="form-check-input" />
                ...
                <div class="form-card">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="color-input-group">
                      <input id="color" v-model="form.metadata.color" type="color" class="form-control form-control-color" />
                      <input v-model="form.metadata.color" type="text" class="form-control" placeholder="#ff6b6b" />
                    </div>
                  </div>

                  <div class="mb-3">
                    <label for="description_short" class="form-label">Mô tả ngắn</label>
                    <input id="description_short" v-model="form.metadata.description_short" type="text" class="form-control" placeholder="VD: Giảm giá lên đến 70%" />
                  </div>

                  <div class="mb-3">
                    <label for="tags" class="form-label">Tags</label>
                    <input id="tags" v-model="tagsInput" type="text" class="form-control" placeholder="black-friday, sale, limited-time" />
                    <div class="form-text">
                      Phân cách bằng dấu phẩy
                    </div>

                    <div v-if="form.metadata.tags && form.metadata.tags.length" class="tags-display mt-2">
                      <span v-for="(tag, index) in form.metadata.tags" :key="index" class="badge bg-secondary me-1 mb-1">
                        {{ tag }}
                        <button type="button" @click="removeTag(index)" class="btn-close btn-close-white ms-1" aria-label="Remove tag" style="font-size: 0.7em;"></button>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-card">
                  ...
                  <div class="d-grid gap-2">
                    <router-link :to="`/admin/sale-campaigns/${campaignId}/products`" class="btn btn-outline-info">
                      <i class="bi bi-box"></i>
                      Quản lý sản phẩm
                    </router-link>

                    <router-link :to="`/sale-campaigns/${currentCampaign.slug || currentCampaign.id}`" class="btn btn-outline-success" target="_blank">
                      <i class="bi bi-eye"></i>
                      Xem trang công khai
                    </router-link>
                  </div>
