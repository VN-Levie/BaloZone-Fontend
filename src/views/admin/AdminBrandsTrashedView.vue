    ...
    <div class="container-fluid py-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
          <router-link to="/admin/brands" class="btn btn-outline-primary">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input id="search" type="text" class="form-control" placeholder="Tên thương hiệu..." v-model="searchTerm" @input="debounceSearch">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select id="sortBy" class="form-select" v-model="sortBy" @change="fetchBrands">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <select id="sortOrder" class="form-select" v-model="sortOrder" @change="fetchBrands">
      ...
      <div class="card shadow">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex gap-2">
            <button class="btn btn-sm btn-success" @click="restoreAllBrands" :disabled="loading || selectedBrands.length === 0" v-if="selectedBrands.length > 0">
              <i class="bi bi-arrow-clockwise me-1"></i>
              Khôi phục đã chọn ({{ selectedBrands.length }})
            </button>
            <button class="btn btn-sm btn-danger" @click="forceDeleteAllBrands" :disabled="loading || selectedBrands.length === 0" v-if="selectedBrands.length > 0">
        ...
        <div class="card-body">
          ...
          <div v-else-if="error" class="alert alert-danger">
            ...
            {{ error }}
            <button class="btn btn-sm btn-outline-danger ms-2" @click="fetchBrands">
              Thử lại
            </button>
          </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr v-for="brand in brands" :key="brand.id">
                  <td>
                    <input type="checkbox" class="form-check-input" :value="brand.id" v-model="selectedBrands">
                  </td>
                  <td>
                    <img :src="brand.logo || 'https://placehold.co/600x400?text=img'" :alt="brand.name" class="img-thumbnail brand-logo" style="width: 50px; height: 50px; object-fit: cover;">
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button class="btn btn-sm btn-success" @click="restoreBrand(brand)" :disabled="loading" title="Khôi phục">
                        <i class="bi bi-arrow-clockwise"></i>
                      </button>
                      <button class="btn btn-sm btn-danger" @click="confirmForceDelete(brand)" :disabled="loading" title="Xóa vĩnh viễn">
